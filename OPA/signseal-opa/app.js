...
const port = 80;
app.listen(port, () => {
    console.log("SignSeal OPA Service is running on port: " + port);
});

// HelloOPA Service router for /health endpoint.
app.get('/health', function (req, res, next) {
    res.status(200).send('Welcome to SignSeal OPA Service. Please make GET policy requests using /request endpoint.');
});
